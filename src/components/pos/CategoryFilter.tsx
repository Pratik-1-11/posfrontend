        ...
        <div className="flex gap-2 overflow-x-auto pb-4 no-scrollbar scroll-smooth">
            {categories.map((category, index) => (
                <button
                    ...
                    className={`px-5 py-2.5 rounded-2xl text-[13px] font-black uppercase tracking-wider whitespace-nowrap transition-all active:scale-95 ${activeCategory === category
